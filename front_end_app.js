...
var launch_server = function(working_dir) {
  ...
  var app = express();
  var port = process.env.PORT2 || 3000;
  ...
  app.use(express.static(working_dir)); // looks for a file named index.html in the working dir
  ...
  console.log("frontend server running on port %d", port);
