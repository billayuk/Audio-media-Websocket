...
var mongoConnectionString = "mongodb+srv://bilsocket:Lizette1991@cluster0.bv5nczk.mongodb.net/mediadb?retryWrites=true&w=majority";

mongoose
  .connect(process.env.MONGO_URL || mongoConnectionString)
  .then(() => {
